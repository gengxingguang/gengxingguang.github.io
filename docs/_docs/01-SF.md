...
### Dateset
The dataset we use is Police Department Incident Reports: Historical 2003 to May 2018. It is from DataSF, an official open data portal of the City and County of San Francisco in California, USA. There are 39 distinct "Incident Category" values in the dataset. Analysing it can help identify crime patterns and trends. This can inform strategies for reducing crime and improving public safety in San Francisco. This dataset can also be used for crime mapping to visualize the geographical distribution of different types of crimes throughout the city.
### Objectives
